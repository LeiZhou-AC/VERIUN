...
def _build_args() -> argparse.Namespace:
    ...
    parser.add_argument("--alpha", type=float, default=0, help="ODR forge mixing coefficient")
    parser.add_argument("--lambda-acc", type=float, default=0.1, help="Retention CE weight")
